      ...
      <div className="hero bg-base-200 min-h-screen">
        <div className="hero-content flex-col lg:flex-row-reverse">
          ...
          <div>
            ...
            <Link href="/" className="bg-blue-400 text-white h-10 p-2  rounded">Create my Resume</Link>
            <Link href="/" className="bg-blue-100 text-blue-700 h-10 p-2 mx-2 rounded">Upload my Resume</Link>
      ...
      <div className="card bg-base-100 max-w-full shadow-sm p-4 m-4">
        ...
        <div className="card-body items-center  text-center">
          ...
          <div className="card-actions">
            <Link href="/" className="btn btn-primary rounded">Create my Resume</Link>
            <Link href="/" className="btn bg-blue-500 rounded text-white">Upload my Resume</Link>
          </div>
        </div>
      </div>
